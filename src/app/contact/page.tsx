...
export const metadata: Metadata = {
  ...
  description: 'Закажите детский праздник в Бельцах. Телефоны: 079181825, 078684285. Адрес: Balti, Centru, 15.',
};
            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-[var(--color-cream)] rounded-xl p-6">
                  ...
                  <p className="text-[var(--color-gray)]">{contactData.workingHours}</p>
                </div>
